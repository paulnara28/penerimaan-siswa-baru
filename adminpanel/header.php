...
<body>
    ...
    <div class="container">
    <a class="navbar-brand" href="#home.php">Aplikasi Penerimaan Siswa baru</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item active">
        <a class="nav-link" href="#">Beranda</a></li>
      <li class="nav-item">
        <a class="nav-link" href="#features">Alur Pendaftaran</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#contact">Hasil Perengkingan</a>
      </li>
      <li class="nav-item">
